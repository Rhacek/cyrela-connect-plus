...
export function StatsCard({
  ...
  return (
    <div className={cn(
      "cyrela-card flex flex-col animate-fade-in p-4",
      className
    )}>
      <div className="flex justify-between items-start mb-3">
        <div className="overflow-hidden">
          ...
          <div className="mt-1 flex items-end">
            <p className="text-2xl font-semibold text-primary font-poppins truncate">{value}</p>
        ...
        {icon && (
          <div className="p-2 bg-cyrela-gray-lighter rounded-md shrink-0">
            {icon}
          </div>
        )}
      </div>
      ...
      {(description || target) && (
        <div className="mt-auto text-xs text-cyrela-gray-dark font-inter space-y-2">
          ...
          {target && (
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="shrink-0">{value}/{target}</span>
              </div>
